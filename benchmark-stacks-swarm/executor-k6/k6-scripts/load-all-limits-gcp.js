  ...
  scenarios: Object.fromEntries(
    targets.map((t) => [
      `load_${t.replace(/[^a-zA-Z0-9]/g, '_')}`,
      {
        ...
        timeUnit: '1s',
        stages: [
          // Aquecimento rápido (rampa curta)
          ...
          // Padrão: ramp ~1min + hold 2min em cada degrau principal
          { duration: '1m', target: 200 },   // ramp até 200
          { duration: '2m', target: 200 },   // hold / observe 2 minutos
          ...
          { duration: '2m', target: 1200 },  // último hold – provavelmente não chega aqui

          { duration: '1m', target: 1300 },
          { duration: '2m', target: 1300 },  // último hold – provavelmente não chega aqui

          { duration: '1m', target: 1400 },
          { duration: '2m', target: 1400 },  // último hold – provavelmente não chega aqui

          { duration: '1m', target: 1500 },
          { duration: '2m', target: 1500 },  // último hold – provavelmente não chega aqui


          // Opcional: ramp down suave para ver recuperação
