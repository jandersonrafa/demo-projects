...
Fazer teste concorrência: while true; do for id in $(seq 1 100); do mysql -uroot -prootpass -p'mypass' -h127.0.0.1 -P3306 -N -e "UPDATE sys.Endereco SET name = CONCAT('Cidade_',RAND()*100) WHERE id=2;"; done; done
