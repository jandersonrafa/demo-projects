...
TEST_WINDOWS = {
    "node": {
        "start": "2026-01-13T17:08:03-03:00",  # Adjusted from 20:08
        "port": 3005,
        "stack": "node",
        "name": "Node.js (NestJS)"
    },
    "java-webflux": {
        "start": "2026-01-13T17:15:24-03:00",  # Adjusted from 20:15
        "port": 3006,
        "stack": "java-webflux",
        "name": "Java WebFlux"
    },
    "java-mvc-vt": {
        "start": "2026-01-13T17:23:54-03:00",  # Adjusted from 20:23
        "port": 3007,
        "stack": "java-mvc-vt",
        "name": "Java MVC VT"
    },
    "python": {
        "start": "2026-01-13T17:31:49-03:00",  # Adjusted from 20:31
        "port": 3008,
        "stack": "python",
        "name": "Python (FastAPI)"
    },
    "php": {
        "start": "2026-01-13T17:41:10-03:00",  # Adjusted from 20:41
        "port": 3009,
        "stack": "php",
        "name": "PHP CLI"
    },
    "php-fpm": {
        "start": "2026-01-13T17:50:01-03:00",  # Adjusted from 20:50
        "port": 3011,
        "stack": "php-fpm",
        "name": "PHP FPM"
    },
    "php-octane": {
        "start": "2026-01-13T18:01:27-03:00",  # Adjusted from 21:01
        "port": 3014,
        "stack": "php-octane",
        "name": "PHP Octane"
    },
    "java-mvc": {
        "start": "2026-01-13T18:09:35-03:00",  # Adjusted from 21:09
        "port": 3016,
        "stack": "java-mvc",
        "name": "Java MVC"
    }
...
def get_container_metrics(stack_key, test_info):
    ...
    print(f"Time window: {test_info['start']} to {datetime.fromtimestamp(end_ts).isoformat()}")
    print(f"{'='*60}")
