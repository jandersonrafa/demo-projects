...
- **CPU P95**: 0.473 cores
- **Memória Média**: 213.12 MB
- **Memória P95**: 230.66 MB
...
- **Menor CPU médio (0.315 cores)**: Processamento muito eficiente
- **Memória estável (~213MB)**: Sem vazamentos ou picos
...
- **CPU eficiente**: Apenas 11% mais CPU que MVC tradicional
...
- **CPU P95**: 0.896 cores
- **Memória Média**: 78.87 MB ⭐ (Menor memória)
- **Memória P95**: 116.82 MB

#### Justificativa das Métricas
- **P95 aceitável (40.65ms)**: Dentro do threshold
- **CPU moderado**: 1.5x mais que Java MVC
- **Memória mínima (78.87MB)**: Node.js é muito eficiente em memória
...
- **CPU alto**: 2.2x mais que Java MVC
...
- **Memória P95**: 997.49 MB ⚠️ (Pico alto)

#### Justificativa das Métricas
- **P95 bom (39.28ms)**: Competitivo com Node.js
- **CPU moderado-alto**: Swoole tem overhead
- **Memória alta e instável**: Pico de 997MB indica possível leak ou pool mal configurado
...
- **CPU P95**: 0.881 cores
- **Memória Média**: 55.69 MB
- **Memória P95**: 58.85 MB
